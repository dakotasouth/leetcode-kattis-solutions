...
public class VaccineEfficacy {
    public static void main(String[] args){
        ...
        if(aVaccE < aContE) System.out.println((aContE - aVaccE) / aContE);
        else System.out.println("Not Effective");
        if(bVaccE < bContE) System.out.println((bContE - bVaccE) / bContE);
        else System.out.println("Not Effective");
        if(cVaccE < cContE) System.out.println((cContE - cVaccE) / cContE);
        else System.out.println("Not Effective");
    }
}
